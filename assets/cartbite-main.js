if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BA1mERQ_a9-j-7ygaylrhpqETCwjAJlKJmuhXESoVeEOWQZQlsAUplkZzmL4HFVa5UWtL5yMT9qWE0T7oW_BpRI",
    clientId: "EYBGS9E1ETFYIAD7BNMPE48G",
    pushOptInSetting: {"delay":86400,"message":{"body":"We will notify you about new products and exclusive promotions","title":"Never miss a sale","buttons":[{"label":"Later","order":1},{"label":"Allow","order":2}],"iconUrl":"https://stlf.s3.ap-south-1.amazonaws.com/stq/bell_oprzpo.png"},"isEnabled":true,"showModal":true,"initialDelay":10},
    subscriberId: '',
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: 'Q5PCY35TPAFM9QRRCFN5GKWT'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'UFHIEDJXBSI7WC1ZGYWH7SGV'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'P1I5W6TH4K4G5PLN7YVVV6QW'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: '1RPSCFYFX85X8ELP8IK69R3G',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'RBTDE8S32FYNJIF5NRQYQTJ3',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: 'WLFPE56G9TYPV8L8PADVSGI9',
    },
    stockWidget: {
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        emailWorkflowUniqueId: "UFHIEDJXBSI7WC1ZGYWH7SGV",
        smsWorkflowUniqueId: "P1I5W6TH4K4G5PLN7YVVV6QW",
